<div class="container">
    ...
    <div class="jumbotron">
        <div class="container">
            ...
            <p>Welcome!</p>
            <p>
                <a class="btn btn-primary btn-lg" href="?p=about">About me</a>
            </p>
        </div>
    </div>
    ...
    <div id="carousel-id" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item">
                <img data-src="" alt="First slide" src="../../img/codigo1.png" class="difu">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Proyecto Inicial</h1>
                        <p>Este fue mi primer intento de una pagina web con html. Es una pagina bastante basica que hice para aprender lo basico.</p>
